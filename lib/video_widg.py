...
fb1=["[bold red]Not quite[/bold red]--a PYNQ board can be referred to as a development board, but this doesn\'t emcompass all of what PYNQ is.","[bold red]Incorrect[/bold red]--operating systems take care of a [black]computer\'s[/black] basic functions. Examples include various versions of Linux and Windows systems, and [black]don\'t[/black] include PYNQ.","[bold green]Correct![/bold green] PYNQ is a framework developed by Xilinx to integrate Python and Python based applications within an FPGA architecture. [black]\'PYNQ\'[/black] comes from Python + ZYNQ--Zynq referring to a specific FPGA architecture developed by Xilinx.",'[bold red]Incorrect[/bold red]--PYNQ is not a game, but you can certainly create one with the help of PYNQ.']
...
fb3=['[bold red]Incorrect[/bold red]; recall what is needed to start the board properly outside of the hardware setup.','[bold red]Incorrect[/bold red]; recall the order of the setup steps.','[bold green]Correct![/bold green] Have the board setup instructions on hand so you don\'t forget any necessary steps.','[bold red]Incorrect[/bold red]; recall that you have to interact with the device through a computer.']
...
fb6_a='[bold red]Try again![/bold red] Refer to the [black]"What is an FPGA?"[/black] notebook, the dropdown widget above, or try to recall what best differentiates these devices from each other.'
